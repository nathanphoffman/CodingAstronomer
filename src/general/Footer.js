        ...
        <div className="row">
            <div className="col-lg-12 col-lg-offset-0 col-md-12 col-md-offset-0">
                ...
                <p className="copyright text-muted">
                    ...
                    <a target="_blank" rel="noopener noreferrer" href="https://creativecommons.org/licenses/by-sa/2.0/">CC-BY-SA 2.0</a>
                    <div>I converted the <a target="_blank" rel="noopener noreferrer" href="http://startbootstrap.com/template-overviews/clean-blog/">Clean Blog</a> template to ReactJS. You can find the React adaptation I did on GitHub: 
                    <a target="_blank" rel="noopener noreferrer" href="https://github.com/webiota/NodeBlog-React">ReactJS</a></div>
                </p>
            </div>
        </div>
    </div>
